...
def test_extracts_post_and_highest_bitrate_video():
    payload = {"data": {"result": {
        ...
        "legacy": {"full_text": "Complete text", "created_at": "Tue Jan 02 03:04:05 +0000 2024", "lang": "zh", "extended_entities": {"media": [{"type": "video", "video_info": {"variants": [
...
def test_timeline_entry_uses_note_text_links_and_excludes_embedded_quote():
    ...
    liked = {
        "rest_id": "1", "note_tweet": {"note_tweet_results": {"result": {"text": "Long post https://t.co/note", "entity_set": {"urls": [{"url": "https://t.co/note", "display_url": "example.com/note", "expanded_url": "https://example.com/note"}]}}}},
        "legacy": {"full_text": "Truncated https://t.co/legacy", "created_at": "Tue Jan 02 03:04:05 +0000 2024", "entities": {"urls": [{"url": "https://t.co/legacy", "display_url": "wrong.example", "expanded_url": "https://wrong.example"}]}, "quoted_status_result": {"result": quote}},
        "core": {"user_results": {"result": {"rest_id": "7", "legacy": {"screen_name": "alice", "name": "Alice"}}}},
    }
    posts = posts_from_x_response({"data": {"entries": [{"entryId": "tweet-1", "content": {"itemContent": {"tweet_results": {"result": liked}}}}]}})
...
def test_extracted_post_removes_media_link_but_keeps_media():
    liked = {
        "rest_id": "1", "legacy": {"full_text": "Keep text https://t.co/media", "created_at": "Tue Jan 02 03:04:05 +0000 2024", "entities": {"media": [{"url": "https://t.co/media"}]}, "extended_entities": {"media": [{"type": "photo", "url": "https://t.co/media", "media_url_https": "https://pbs.twimg.com/media/example.jpg"}]}},
        "core": {"user_results": {"result": {"rest_id": "7", "legacy": {"screen_name": "alice", "name": "Alice"}}}},
    }
...
def test_profile_path_ignores_x_navigation_routes():
    assert pick_profile_path(["/home", "/explore", "/i/notifications", "/messages", "/alice", "/compose/post"]) == "/alice"


def test_extracts_author_from_new_user_core_shape():
    result = {"rest_id": "99", "core": {"user_results": {"result": {"rest_id": "7", "core": {"screen_name": "new_handle", "name": "New Name"}}}}, "legacy": {"full_text": "post", "created_at": "Tue Jan 02 03:04:05 +0000 2024"}}
